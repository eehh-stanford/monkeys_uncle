...
Consider the sample mean, $\bar{G}_n$. It's a standard estimator of the quantity we're interested in (i.e., $G_N$) because, as Meng notes, it's consistent under both both design and model-based samples. We can write the sample mean in terms of what Meng calls its $R$-Mechanism, where $R$ stands for *Reporting*, *Responding*, or *Responding* for big data or *Random* for a probabilistic sample
